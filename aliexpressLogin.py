...
def get_umidToken_csrf_token(login_account):
    url = 'https://passport.aliexpress.com/mini_login.htm?lang=pt_br&appName=aebuyer&appEntrance=default&styleType=auto&bizParams=&notLoadSsoView=false&notKeepLogin=true&isMobile=false&showMobilePwdLogin=false&defaultCountryCode=BR&ut=&rnd=0.9085151696364684'
